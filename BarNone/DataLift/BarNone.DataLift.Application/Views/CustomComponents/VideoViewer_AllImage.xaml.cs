...
namespace BarNone.DataLift.UI.Views.CustomComponents
{
    ...
    /// </summary>
    public partial class VideoViewer_AllImage : UserControl
    {
        #region Constructor(s)
        /// <summary>
        /// Initializes the view
        /// </summary>
        public VideoViewer_AllImage()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty ImageSourceLeftProperty =
            DependencyProperty.Register("ImageSourceLeft", typeof(ImageSource), typeof(VideoViewer_AllImage), new FrameworkPropertyMetadata(GetDefaultCanvas(200, 200)));
        ...
        public static readonly DependencyProperty ImageSourceRightProperty =
            DependencyProperty.Register("ImageSourceRight", typeof(ImageSource), typeof(VideoViewer_AllImage), new FrameworkPropertyMetadata(GetDefaultCanvas(200, 200)));
        ...
        public static readonly DependencyProperty ImageSourceMiddleProperty =
            DependencyProperty.Register("ImageSourceMiddle", typeof(ImageSource), typeof(VideoViewer_AllImage), new FrameworkPropertyMetadata(GetDefaultCanvas(600, 400)));
