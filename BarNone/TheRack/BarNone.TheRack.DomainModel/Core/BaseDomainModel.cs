...
namespace BarNone.TheRack.DomainModel.Core
{
    ...
    public abstract class BaseDetailDomainModel<TDomainModel, TDTO, TDetailDTO> : DetailDTOTransformable<TDomainModel, TDTO, TDetailDTO>, IDetailDomainModel<TDomainModel, TDTO, TDetailDTO>
        where TDomainModel : BaseDetailDomainModel<TDomainModel, TDTO, TDetailDTO>, IDetailDomainModel<TDomainModel, TDTO, TDetailDTO>, new()
