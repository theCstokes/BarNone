...
{
    public class AngleAnalysisCriteriaConverter 
        : BaseDetailDataConverter<AngleAnalysisCriteria, AngleAnalysisCriteriaDTO, AngleAnalysisCriteriaDetailDTO, Converters>
    {
        public AngleAnalysisCriteriaConverter(Converters converterContext, IDomainContext context) : base(converterContext, context)
        {
        }
