...
{
    public class SpeedAnalysisProfileConverter 
        : BaseDetailDataConverter<SpeedAnalysisCriteria, SpeedAnalysisCriteriaDTO, 
            SpeedAnalysisCriteriaDetailDTO, Converters>
    {
        public SpeedAnalysisProfileConverter(Converters converterContext, IDomainContext context) : base(converterContext, context)
        {
        }

        public override PositionAnalysisCriteria OnCreateDataModel(SpeedAnalysisCriteriaDTO dto)
        {
