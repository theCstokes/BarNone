...
namespace BarNone.Shared.DomainModel.Core
{
    ...
    public abstract class DomainModel<TDomainModel, TDTO> : IDomainModel<TDTO>
        where TDomainModel : DomainModel<TDomainModel, TDTO>, new()
        where TDTO : BaseDTO<TDTO>, new()
    {
        public abstract int ID { get; set; }

        dynamic IDomainModel.CreateDTO(ConvertConfig config = null)
        {
        ...
        public static TDomainModel CreateFromDTO(TDTO dto, ConvertConfig config = null)
        {
            var dm = new TDomainModel();
            dm.PopulateFromDTO(dto);
            return dm;
    ...
    public abstract class DetailDomainModel<TDomainModel, TDTO, TDetailDTO> : DomainModel<TDomainModel, TDTO>
        where TDomainModel : DetailDomainModel<TDomainModel, TDTO, TDetailDTO>, new()
